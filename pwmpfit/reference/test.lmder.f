...
c      nwrite = 7
   ...
   60 FORMAT ( //// 5X, 8H PROBLEM, I5, 5X, 11H DIMENSIONS, 2I5, 5X //
     *         )
   70 FORMAT (5X, 33H INITIAL L2 NORM OF THE RESIDUALS, D22.14 // 5X,
     *        33H FINAL L2 NORM OF THE RESIDUALS  , D22.14 // 5X,
     *        33H NUMBER OF FUNCTION EVALUATIONS  , I10 // 5X,
     *        33H NUMBER OF JACOBIAN EVALUATIONS  , I10 // 5X,
     *        15H EXIT PARAMETER, 18X, I10 // 5X,
     *        27H FINAL APPROXIMATE SOLUTION // (5X, 5D22.14))
...
c 666        FORMAT(3HJJ , I3, I3, D22.14)
   50       CONTINUE
   60    CONTINUE
      GO TO 500
C
