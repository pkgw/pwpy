...
set in=mosfxc-3c286.uvaver.uvcal*.uvredo
set outroot=3c286.all

invert vis=mosfxc-3c286.uvaver.uvcal\*.uvredo options=mfs map=${outroot}.mp beam=${outroot}.bm sup=0 #line=ch,25,100
