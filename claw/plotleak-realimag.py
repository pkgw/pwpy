...
def run():
    ...
    for i in range(1,160):
        ...
        try:
            a.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm-best/day1-1430-hires/mosfxa-3c286-1430-100-leakamp%d.txt' % i))
            p.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm-best/day1-1430-hires/mosfxa-3c286-1430-100-leakphase%d.txt' % i))
        except:
            print 'skipping %d' % (i)
    print 'now building leak plot 2'
    for i in range(1,160):
        try:
            a2.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm-best/day2-1430-hires/mosfxa-3c286-1430-100-flagged-leakamp%d.txt' % i))
            p2.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm-best/day2-1430-hires/mosfxa-3c286-1430-100-flagged-leakphase%d.txt' % i))
