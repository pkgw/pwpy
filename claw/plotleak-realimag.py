...
def run():
    ...
    for i in range(1,17):
        ...
        try:
            a.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm-best/day2-1800/mosfxc-3c286-1800-100-flagged-leakamp%d.txt' % i))
            p.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm-best/day2-1800/mosfxc-3c286-1800-100-flagged-leakphase%d.txt' % i))
        except:
            print 'skipping %d' % (i)
    print 'now building leak plot 2'
    for i in range(1,17):
        try:
            a2.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm2/try8-1800/test-leakamp%d.txt' % i))
            p2.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm2/try8-1800/test-leakphase%d.txt' % i))
