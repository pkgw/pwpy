...
def run():
    ...
    for i in range(1,161):
        try:
            a2.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm-best/day1-2010-hires/mosfxc-3c286-2010-100-leakamp%d.txt' % i))
            p2.append(asciidata.AsciiData ('/indirect/big_scr3/claw/data/ata/nvss-rm-best/day1-2010-hires/mosfxc-3c286-2010-100-leakphase%d.txt' % i))
        except:
            print 'skipping %d' % (i)
